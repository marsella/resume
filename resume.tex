...
\begin{itemize}[label={}]
  \item \textbf{Galois, Inc}, USA (remote) \\
  \textit{Research Engineer.} November 2023 - present.
  \begin{itemize}[leftmargin=*, noitemsep, topsep=0pt]
    \item Led project to develop \href{https://github.com/GaloisInc/cryptol-specs/}{high-quality Cryptol specifications} for 12+ NIST cryptography specs, including implementation, documentation and usability, developing readability standards, and education.
    \item Built and maintained CI (on GitLab and GitHub) for projects supporting Rust, Haskell, and custom formal verification pipelines. Improved performance of existing systems by 20\% (caching, pipelining).
    \item Performed as a software developer on contracts, focusing on effectively architecting code, maintaining readable documentation, comprehensive testing, and preparing effective transitions to clients.
  \end{itemize}
...
\begin{itemize}[label={}]
  \item \textbf{cryptol-specs} [\href{https://github.com/GaloisInc/cryptol-specs/}{\texttt{https://github.com/GaloisInc/cryptol-specs/}}]\\
